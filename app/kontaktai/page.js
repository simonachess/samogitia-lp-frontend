  ...
  return (
    <section className="page-section">
      <div className="page-container flex flex-row flex-wrap items-start justify-center text-center text-primary-800 font-body-regular-400">
        <div className="max-w-[960px] w-full flex flex-col py-0 px-2.5 box-border items-center justify-start gap-10 md:gap-20 animate-fade-in-up opacity-0 [animation-fill-mode:forwards]">
