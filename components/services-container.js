...
const ServicesContainer = ({ items = [] }) => {
  ...
  return (
    <section className="w-full bg-primary-50 py-[40px] md:py-[80px] flex flex-col items-center text-center body-regular-600">
      <div className="max-w-[1200px] mx-auto px-4 w-full items-center flex flex-col items-center justify-start gap-10 md:gap-20 text-center text-primary-800 font-body-regular-400">
