const Hero = () => {
  return (
    <div className="w-full flex flex-col py-[120px] md:py-[80px] items-center bg-[url(/hero-section@3x.png)] bg-cover bg-no-repeat bg-[top] text-center text-33xl text-gray-white font-body-regular-400">
