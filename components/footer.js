...
const Footer = () => {
  return (
    <div className="w-full flex px-4 py-[40px] items-start justify-start flex-wrap">
      <footer className=" max-w-[1200px] px-4 mx-auto flex-1 flex flex-row items-start justify-between text-left text-5xl text-gray-black font-body-regular-400 md:flex-col md:gap-[50px] sm:flex-col sm:gap-[50px]">
